...
Το παιχνίδι σου θα ξεκινήσει με μια οθόνη «αρχή» και οι παίκτες θα κάνουν κλικ στο έντομο για να μεταβούν στο πρώτο επίπεδο.
</div>
<div>
...
Άλλαξε το όνομα του υπόβαθρου σε `αρχή`, γιατί θα χρειαστεί να το επιλέξεις αργότερα στο έργο.
