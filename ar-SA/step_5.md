...
--- task --- Join the blocks back to the `when this sprite clicked`{:class="block3events"} block so that clicking on the bug switches to the `next backdrop`{:class="block3looks"}:
